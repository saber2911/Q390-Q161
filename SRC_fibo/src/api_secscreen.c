...
{
	return hal_secscrClrLine(startline, endline);
}
...
{
	hal_secscrSetBackLightMode(mode, time);
}
...
{
	hal_secscrSetBackLightValue(ucValue);
}
...
{
	return hal_secscrSetAttrib(attr, value);
}
...
{
	return hal_secscrGetAttrib(attr);
}
...
{
	hal_secscrGotoxyPix(pixel_X, pixel_Y);
}
...
{
	hal_secscrGetxyPix(pixel_X, pixel_Y);
}
...
void secscrPrint_lib(uint col, unsigned char row, unsigned char mode, const char *str, ...)
{
	...
	hal_secscrPrint(col, row, mode, "%s", rP);
...
void secscrPrint_xy(uint col, uint row, unsigned char mode, const char *str, ...)
{
	...
	hal_secscrPrintxy(col, row, mode, "%s", rP);
...
void secscrPrint_Ex(uint col, unsigned char row, unsigned char mode, const char *chstr, const char *enstr)
{
	...
	hal_secscrPrintEx(col, row, mode, chstr, enstr);
...
{
	hal_secscrTextOut(pixel_X, pixel_Y, str);
}
...
{
	return hal_secscrDrawDot(x, y, Mode);
}
...
{
	return hal_secscrGetPixel(x, y, picolor);
}
...
{
	return hal_secscrDrawStraightLine(sx, sy, ex, ey, Mode);
}
...
{
	hal_secscrDrawRect(left, top, right, bottom, Mode);
}
...
{
	hal_secscrDrawRectColor(left, top, right, bottom, color);
}
...
{
	return hal_secscrDrawRectBlock(left, top, right, bottom, color);
}
...
{
	return hal_secscrWriteLogo(left, top, data);
}
...
{
	hal_secscrGetLcdSize(width, height);
}
