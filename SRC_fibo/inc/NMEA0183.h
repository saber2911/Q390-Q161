...
static void update_stll_msg(gps_gsv* gsvMsg, unsigned char len, unsigned char prn, unsigned char dbh, unsigned char evl, int azi);  //更新卫星的信息
...
#define NMEA0183_FRAME_MAX_LEN		1024   //NMEA数据帧的最大长度
#define NMEA0183_GSV_MAX_LEN		72   //NMEA数据帧的最大长度
...
extern gps_gsv gpgsv[NMEA0183_GSV_MAX_LEN];  
extern gps_gsv glgsv[NMEA0183_GSV_MAX_LEN];  
extern gps_gsv gbgsv[NMEA0183_GSV_MAX_LEN];
